            ...
            <div class="jumbotron" style="width: 60%; background-color: #141414;">
                ...
                <form method="post">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="password" class="form-control" name="novasenha" placeholder="Digite a nova senha aqui!" required><br><br>
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text bg-warning" id="inputGroup-sizing-default" style="height: 38px;">Confirmação</span>
                        </div>
                        <input type="password" class="form-control" name="confirmanovasenha" placeholder="Digite a confirmação de senha!" required><br><br>
                    </div>
