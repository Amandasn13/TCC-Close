...
<body>
    ...
    <header>
        ...
        <section>
            <center>
                <form method="post" name="AP" style="border: 3px solid whitesmoke; width: 25%;">
                    <center>
                        ...
                        <input type="password" id="l2" style="width: 280px;" name="senhalogin" placeholder="Digite sua senha" required><br>
                        ...
                        <a href="#hpnv" id="fgs">Desejo me cadastrar</a><br><br>
                    </center>
                    ...
                    <div class="container">
                        ...
                        <div class="row justify-content-around">
                            <div class=col-4>
                                ...
                                <input type="password" name="csenha" id="pwr" onkeyup="validatePassword(this.value);" style="width: 365px;" placeholder="Digite sua senha (use simbolos, letras e números)" maxlength="100" class="form-control" required>
                                <span id="msg" class="input-group-text" style="font-family: Segoe UI; font-style: bold; width: 365px;"></span>
                                <br><br>
                            </div><br>
                            <div class="col-4">
                                <input type="password" name="ccsenha" id="pwr2" style="width: 365px; border-radius: 25px;" placeholder="Confirme sua senha" class="form-control" maxlength="100" required>
                                <a onclick="verSen()" style="text-decoration: none; color: black; font-size: 15px;"> 👁 Clique aqui para ver as senhas</a><br><br>
                                <input type="submit" id="btn-alert" name="cadastro" value="Cadastrar" style="width: 365px;" class="botao" onclick="Mensagem()">
        </center>
        </div>
        </div>
