    ...
    <body id="pg" onload='hey()'>
        ...
        <section>
            <center>
                ...
                <br>
                <hr style="height: 2px; background-color: rgb(201, 198, 198); width: 60%; opacity: 30%;">
            </center>
            <br>
            <center>
                <h3 id="subs"> O que deseja fazer agora?</h3><br>
            </center>
                                                                ...
                                                                <div class="modal-content" style="background-color: rgb(17, 14, 14);">
                                                                    ...
                                                                    <div class="container">
                                                                        <div class="tab-content">
                                                                            ...
                                                                            <div id="ApDds<?php echo $foto['IdRoupa']; ?>" role="tabpanel" class="tab-pane fade in">
                                                                                ...
                                                                                <center>
                                                                                    <form method="post" name="apagarfoto">
                                                                                        ...
                                                                                        <input type="submit" value="Sim, desejo apagar" class="btn btn-primary">
                                                                                </center><br>
                                                                                <?php
                                                                            ...
                                                                            <!--Editar Roupa-->
                                                                            <div id="EdIn<?php echo $foto['IdRoupa']; ?>" role="tabpanel" class="tab-pane fade in">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        ?>
                                                            <td>
                                                                <div class="col">
                                                                    <button class="btn btn-dark" style="width: 350px;" data-toggle="modal" data-target="#LkMod<?php echo $fotolook['IdLook']; ?>"> <?php echo $fotolook['Nome']; ?> </button>
                                                                </div>
                                                                <!--Fecha componente da grid (alinhamento)-->
                                                            </td>
        ...
        <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="ModCadRp">
            <div class="modal-dialog modal-xl">
                <div class="modal-content" style="background-color: rgb(17, 14, 14); color: azure;">
                    <header>
                        <center>
                            <h2 style="color: azure;"> Cadastro de roupas</h2>
                    </header>
                    <div>
                        <form method="post" class="px-4 py-3" action="PHP/cadastrarfotoroupas.php" id="est-f" enctype="multipart/form-data">
                            <br>
                            <h4>Por favor, preencha as lacunas abaixo com os dados necessários para o cadastro da peça de roupa</h4>
                            </center><br>
                            <div class="container">
        ...
        <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="ModCadLk">
            <div class="modal-dialog modal-xl">
                <div class="modal-content" style="background-color: rgb(17, 14, 14); color: azure;">
                    <header>
                        <center>
                            <h2 style="color: azure;"> Cadastro de looks</h2>
                        </center>
                    </header>
                    <div>
                ...
                <div class="modal-content" style="background-color: transparent; color: rgb(251, 255, 9);  border-style: none;">
                    <div class="modal-body" style="position: relative;">
                        <div class="modal-header" style="border-bottom: none;">
                            <center>
                                <h4 style="padding-left: 100px;">Olá! Esse é seu Guarda-Roupa, para aprender um pouco mais sobre como ele funciona e como
                                    usá-lo é só seguir as dicas abaixo
                            </center>
                            </h4><br>
                        ...
                        <img src="IMG\psps1.png" width="1200px" height="600px" style="position: absolute; left:50%; top:50%; margin-top: -10px; margin-left:-600px;">
                    </div>
                </div>
            </div>
        </div>
